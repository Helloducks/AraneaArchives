...
namespace AraneaArchives.Controllers
{
    public class NotesController : Controller
    {
        ...
        {
            var araneaArchivesContext = _context.Notes.Include(n => n.Directorys);
            return View(await araneaArchivesContext.ToListAsync());
        }
        ...
        public async Task<IActionResult> Create([Bind("NotesId,NoteName,NoteContents,DirectoryId")] Notes notes)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("NotesId,NoteName,NoteContents,DirectoryId")] Notes notes)
        {
            if (id != notes.NotesId)
            {
                return NotFound();
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'AraneaArchivesContext.Notes'  is null.");
            }
            var notes = await _context.Notes.FindAsync(id);
            if (notes != null)
            {
